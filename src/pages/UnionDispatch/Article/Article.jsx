...
\`<pre>\` and \`<code>\` blocks are automatically escaped -- you do not
need to use entities. Just type naturally, and Markdown will escape
...
wish, you may use spaces between the hyphens or asterisks.
...
function Article() {
  ...
  const title = "Dynamic Rendering";
  const author = "Harsh Patel";
    ...
    <>
      ...
      <div className="after-markdown-render">
        <blockquote>
          ...
          <MarkdownRenderer
            markdownContent="
Follow me on [Instagram](https://www.instagram.com/harshpatel0)  
Hello! (To add a line break, add two spaces to the ending of the previous text, and bobs your uncle)  
You can add so many lines here! Don't, just add a quote, plug, whatever and go!
        "
          />
        </blockquote>
        <code>
